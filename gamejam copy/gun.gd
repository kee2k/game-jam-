...
func _shoot():
	...
	# spawn bullet slightly in front of the gun so it appears next to the player
	var muzzle_offset: Vector2 = Vector2(12, 0).rotated(rotation_offset.global_rotation)
	new_bullet.global_position = global_position + muzzle_offset
	new_bullet.speed = 50
